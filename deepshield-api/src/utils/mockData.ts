...
export const intelligenceData = {
  SUI: { price: "$2.00", trend: "Bullish", move: "+4.2%", confidence: 92, action: "Protected Buy", explanation: "Risk Score 92. Reason: High whale accumulation detected in the last 2 hours. Spread is tightening, indicating strong liquidity support for an upward move." },
  DEEP: { price: "$0.10", trend: "Neutral", move: "+1.1%", confidence: 75, action: "Hold", explanation: "Risk Score 75. Reason: Liquidity is stable but volume is low. No significant whale movements detected. Hold until trend confirms." },
  CETUS: { price: "$1.00", trend: "Bearish", move: "-3.5%", confidence: 88, action: "Wait", explanation: "Risk Score 88. Reason: Large sell wall detected. Liquidity depth on the bid side is weak, making it highly susceptible to slippage hunting bots." },
  WAL: { price: "$3.00", trend: "Bullish", move: "+8.4%", confidence: 95, action: "Protected Buy", explanation: "Risk Score 95. Reason: Flash loan activity observed recently, but strong buy pressure absorbing the impact. Ideal for protected routing to avoid sandwich attacks." }
};
